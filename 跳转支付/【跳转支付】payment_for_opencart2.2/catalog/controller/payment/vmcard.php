...
class ControllerPaymentVmcard extends Controller{
    ...
    public function index(){
       ...
       // $this->response->setOutput($this->load->view('payment/vmcard', $data));
        return $this->load->view('payment/vmcard', $data);
    }
    ...
    public function callback(){
        ...
        if($MD5sign == $rData['MD5info']) {
            ...
            if($rData['Succeed'] == '88') {
                ...
                $retulrTemp = 'payment/vmcard_success';
                ...
                $retulrTemp  = 'payment/vmcard_failure';
            ...
            $this->response->setOutput($this->load->view($retulrTemp, $data));

        } else {
            $data = array_merge($data, $this->request->post);
         
            $this->response->setOutput($this->load->view('payment/vmcard_failure',$data));
        }
    }
