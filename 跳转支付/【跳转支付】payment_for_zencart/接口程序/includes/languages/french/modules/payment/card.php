...
//  $Id: card.php v1.0 $
//
  define('MODULE_PAYMENT_CARD_TEXT_ADMIN_TITLE', 'CreditCard');
  define('MODULE_PAYMENT_CARD_TEXT_CATALOG_TITLE', 'CreditCard');
  define('MODULE_PAYMENT_CARD_TEXT_DESCRIPTION', 'Creditcard');
  ...
  define('MODULE_PAYMENT_CARD_ACCEPTANCE_MARK_TEXT', '');
