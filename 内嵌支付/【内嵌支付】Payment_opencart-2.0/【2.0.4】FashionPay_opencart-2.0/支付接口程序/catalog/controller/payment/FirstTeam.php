...
class ControllerPaymentFirstTeam extends Controller {
	...
	if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/FirstTeam.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/FirstTeam.tpl', $data);
		} else {
			return $this->load->view('default/template/payment/FirstTeam.tpl', $data);
		}
