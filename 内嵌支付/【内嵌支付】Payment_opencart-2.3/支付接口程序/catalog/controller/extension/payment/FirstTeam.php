...
class ControllerExtensionPaymentFirstTeam extends Controller {
	...
	public function index() {
		...
		return $this->load->view('extension/payment/FirstTeam', $data);
		//$this->render();
	}
	...
	public function send() {
		...
		$this->load->model('extension/payment/FirstTeam');
     ...
     //************   行用卡参数检测提示 End  *************//   
	    ...
	    */
		...
		if($Succeed == '88'){
			...
			$json['success'] = $this->url->link('extension/checkout/checkout_result', '', 'SSL');
