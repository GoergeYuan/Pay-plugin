<?php
class ControllerExtensionPaymentFirstTeam extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('extension/payment/FirstTeam');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('common/dashboard', 'token=' . $this->session->data['token'], 'SSL', true)
		);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/FirstTeam', 'token=' . $this->session->data['token'], 'SSL')
		);

		//$data['action'] = HTTPS_SERVER . 'index.php?route=payment/FirstTeam&token=' . $this->session->data['token'];
		$data['action'] = $this->url->link('extension/payment/FirstTeam', 'token=' . $this->session->data['token'], true);
...
//return url
		...
		$this->response->setOutput($this->load->view('extension/payment/FirstTeam', $data));
	}

	

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/payment/FirstTeam')) {
