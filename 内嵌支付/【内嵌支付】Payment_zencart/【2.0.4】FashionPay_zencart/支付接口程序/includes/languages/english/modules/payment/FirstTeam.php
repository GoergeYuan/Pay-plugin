...
//  $Id: FIRSTTEAM.php v1.0 2014-10-23 Shell·Wang $
 ...
 //支付页面titel信息 
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_DESCRIPTION', '<a target="_blank" href="http://manager.mytradeshops.com/newReg.jsp">Click here to apply for an account</a><br /><br /><a target="_blank" href="http://manager.mytradeshops.com/merchant/">Click to login Su Huitong business page</a><br /><br /><strong>Claim:</strong><br /><hr />*<strong>Su Huitong Business Number</strong> (See application link above)<br />*<strong>It requires the server to open curl</strong>And must be compiled into PHP and SSL<br />*<strong>Su Huitong username and transaction key</strong>business page');
