...
//  $Id: FIRSTTEAM.php v1.0 2014-10-23 Shell·Wang $
 ...
 //支付页面titel信息 
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_CATALOG_TITLE', 'Betalning med kreditkort');
  ...
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_CREDIT_CARD_NUMBER', 'Kortnummer:');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_CREDIT_CARD_EXPIRES', 'Utgångsdatum:');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_CREDIT_CARD_ISSUING_BANK', 'Utgivande Bank:');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_MONTH', 'Månad');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_YEAR', 'År');
 //支付返回结果信息 
  
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_MIDDLE_DIGITS_MESSAGE', 'Vänligen skicka detta mail till ekonomiavdelningen så att den kan lämnas in tillsammans med online-beställning det gäller: ' . "\n\n" . 'Beställa: %s' . "\n\n" . 'USA siffror: %s' . "\n\n");
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_SUCCESS_MESSAGE',
	'<div style="background:#ffedde;padding:10px;line-height:15px">
		...
		<div style="padding:3px;">Betalningsbelopp :%s</div>
		<div style="padding:3px;">Betalningsstatus :%s</div>
		<div style="padding:3px;">produktnamn   :%s</div><br/>
	</div>');
 define('SP_PAYRESULT_Error_code','Felkod: ');
 define('SP_PAYRESULT_SUCCESS','Grattis, är betalningen framgångsrik!');
 define('SP_PAYRESULT_FAIL','Tyvärr, är betalning misslyckande, är orsaken: ');
 define('SP_PAYRESULT_WARNING','Tyvärr, är betalning misslyckande, är orsaken datavalidering misslyckades, kontakta kund ägaren!');
 define('SP_PAYRESULT_PROCESSING','Vänta en stund, är orderhantering, inte betala igen senare!');


//异常卡信息
  define('FIRSTTEAM_PAYMENT_ERROR_CVV', 'CVV / Csc koden är felaktig !');
  define('FIRSTTEAM_PAYMENT_ERROR_CARD', 'Kreditkortsnummer är felaktigt !');
  define('FIRSTTEAM_PAYMENT_ERROR_CARDTYPE', 'Typen kreditkort stöds inte!');
  define('FIRSTTEAM_PAYMENT_ERROR_YEAR', 'Året för utgångsdatum är felaktig !');
  define('FIRSTTEAM_PAYMENT_ERROR_MONTH', 'Månad Utgångsdatumet är felaktigt!');
  define('FIRSTTEAM_PAYMENT_ERROR_EXPIRE', 'Den utgångsdatum har gått ut !');
  define('FIRSTTEAM_PAYMENT_ERROR_NONE_CARD', 'Betalningen stöds inte någon korttyp, vänligen kontakta butiken kundtjänst !\n'); 
  define('FIRSTTEAM_PAYMENT_ERROR_CARD_TYPE', 'Typen kreditkort stöds inte !\n');
  define('FIRSTTEAM_PAYMENT_ERROR_CARD_ALLOW','Vi stöder korttyp : ');


//JS异常卡信息
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_NUMBER', '* Kortnummer är fel!\n');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_CVV', '* CVV2 / CSC är fel!\n');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_EXPIRES_MONTH', '* Kreditkorts Utgår månad Error!\n');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_EXPIRES_YEAR', '* Kreditkort går ut år Fel!\n');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_ISSUING_BANK', '* Kreditkorts Utgivande Bank Fel!\n');
  define('MODULE_PAYMENT_FIRSTTEAM_TEXT_JS_SP_RESUBMIT', 'Vänta en stund, är orderhantering, inte skicka betalningen igen!');
